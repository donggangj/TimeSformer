...
default_cfgs = {
    'vit_base_patch16_224': _cfg(
        url='https://github.com/rwightman/pytorch-image-models/releases/download/'
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        # 1 Temporal Attention Parameters
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        # 1 initialization of temporal attention weights
        if self.attention_type == 'divided_space_time':
            i = 0
    ...
    def forward_features(self, x):
        ...
        # 1 resizing the positional embeddings in case they don't match the input at inference
        ...
        # 2 Predictions for space-only baseline
        if self.attention_type == 'space_only':
